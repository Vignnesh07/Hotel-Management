    ...
    return(
        <>
            <View style={styles.container}>
                ...
                <View>
                    <Text style={{fontSize:30, paddingLeft: 15, marginTop: 50, color: 'black', fontWeight: 'bold', textAlign: 'center'}}>Unfortunate Things Happen </Text>
                    <Text style={{fontSize: 15, marginTop: 5, paddingLeft: 14, color: Colors.grey, textAlign: 'center'}}>Enter your email account. We’ll send you the instructions to reset your password. </Text>
                </View>
