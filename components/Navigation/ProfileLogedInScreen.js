                ...
                <View>
                    <Text style={{ 
                        fontSize:30, 
                         ...
                         marginTop: 20, 
                         color: 'black', 
                         fontWeight: 'bold'}}> Hi, I'm Babe
                    </Text>
                    <Text style={{ 
                         fontSize:20, 
                         marginTop: 10,
                         paddingLeft: 25,  
                         color: Colors.grey}}>Joined in 2022
                    </Text>
                </View>
                ...
                <View>
                    <Text style={{ 
                        fontSize:30, 
                         ...
                         marginTop: 20, 
                         color: 'black', 
                         fontWeight: 'bold'}}> About
                    </Text>
                    <Text style={{ 
                         fontSize:16, 
                         marginTop: 10,
                         paddingLeft: 27,  
                         color: 'black'}}>LiJonn's babe
                    </Text>
                    ...
                    <View style={{flexDirection:'row', paddingLeft:27, paddingTop: 15}} >
                        ...
                        <Text style={{fontSize: 17, paddingLeft: 20, color: 'black'}}> Speaks English, Melayu, 中文 (bad words) </Text>
                    </View>
                    <View style={{flexDirection:'row', paddingLeft:27, paddingTop: 15}} >
                ...
                <View>
                    <Text style={{ 
                        fontSize:30, 
                         ...
                         marginTop: 20, 
                         color: 'black', 
                         fontWeight: 'bold'}}> Babe Confirmed
                    </Text>
                    <View style={{flexDirection:'row', paddingLeft:27, paddingTop: 20}} >
